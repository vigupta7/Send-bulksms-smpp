...
//import sun.io.CharToByteConverter; //import java.nio.charset.*;
...
public class ShortMessage extends ByteData
{
    ...
    public void setUDHMessage(String message, String encoding,String udh)
    	    throws WrongLengthOfStringException,
    	           UnsupportedEncodingException
    	    {
    	        ...
    	        if (message!=null) {
    	        		try {
    	        			...
    	        			buff.appendBytes(udh.getBytes());
    	        			buff.appendBytes(message.getBytes(encoding));
    	        			messageData = buff.getBuffer();
    	            ...
    	            //System.out.println("udh message = " + this.message);
